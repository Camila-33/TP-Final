...
import GestionStock.Enum.MenuStock;
...
public class GestionMenu {
    ...
    public GestionMenu()
    {
        ...
        this.gestionProducto = new GestionProducto(inventario);
        ...
        this.gestionCompra = new GestionCompra(gestionProducto, inventario);

        this.gestionVenta = new GestionVenta(inventario, gestionProducto);
            ...
            switch (opcion) {
                ...
                case 2:
                    ...
                    try {
                        ...
                        inventario.setIdUsuario(administrador.getIdUsuario());
    ...
    public void gestionStockAdministrador()
    {
        while (true) {
            ...
            int opcion = MenuStock.getOpcion();
            ...
            switch (opcion) {
                ...
                case 1:
                    ...
                    String tablaStock = inventario.listarLotesProducto(codigo);

                    System.out.printf(tablaStock);
                    break;

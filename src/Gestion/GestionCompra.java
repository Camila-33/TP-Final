...
public class GestionCompra {
    ...
    public GestionCompra(GestionProducto gestionProducto, Inventario inventario)
    {
    ...
    public void agregarYguardar(Compra compra)
    {
        ...
        {
            Lote nuevaEntrada = new Lote();

            nuevaEntrada.setIdProducto( detalleCompra.getProducto().getCodigo() );

            nuevaEntrada.setIdProveedor( compra.getProveedor().getIdProveedor() );

            nuevaEntrada.setCantidadInicial( detalleCompra.getCantidad() );

            nuevaEntrada.setPrecioUnitario( detalleCompra.getPrecioUnitario() );

            inventario.ingresarProducto(nuevaEntrada);
        }
    }

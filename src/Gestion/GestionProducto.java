...
public class GestionProducto {
    ...
    public void agregarProducto(Producto p){
        ...
        inventario.ingresarProducto(
                new Lote( p.getCodigo(), p.getIdProveedores().getFirst(), p.getStock(), p.getPrecio() )
        );
    }
    ...
    public void agregarProductos(HashMap<String, Producto> productos){
        ...
        for (Map.Entry<String, Producto> entry : productos.entrySet())
        {
            ...
            inventario.ingresarProducto(
                    new Lote( producto.getCodigo(), producto.getIdProveedores().getFirst(), producto.getStock(), producto.getPrecio() )
            );

...
public class GestionVenta {
    ...
    public Venta cargarOrdenVenta() {
        ...
        // calculo el total a partir de los detalles
        double total = calcularTotal(detalles);

        // tu constructor original: Venta(List<DetalleVenta>, double total, LocalDate fecha, boolean activo)
        Venta nuevaVenta = new Venta(detalles, total, LocalDate.now(), true);
    ...
    public void cancelarOrdenDeVenta(String idVenta) {

        Venta venta = buscarOrdenVentaPorId(idVenta);

        if (venta == null) {
            System.out.println("No se encontró una orden de venta con ese ID");
            return;
        }
    ...
    public void mostrarOrdenVentaPorId(String idVenta) {
        Venta v = buscarOrdenVentaPorId(idVenta);
        if (v == null) {
            System.out.println("No se encontró una orden de venta con ese ID");
        } else {
    ...
    public void modificarOrdenVenta(String idVenta) {
